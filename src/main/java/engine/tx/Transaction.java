...
import engine.file.*;
import engine.log.LogMgr;
import engine.buffer.*;
import engine.tx.recovery.*;
import engine.tx.concurrency.ConcurrencyMgr;
...
public class Transaction {
    ...
    * {@link engine.server.SimpleDB}.
    * Those objects are created during system initialization.
    * Thus this constructor cannot be called until either
    * {@link engine.server.SimpleDB#init(String)} or
    * {@link engine.server.SimpleDB#initFileLogAndBufferMgr(String)} or
    * is called first.
    */
